...
Ayudas a consultar el estado del inventario, la disponibilidad de implementos y el estado de prestamos.

REGLAS DE OPERACION:
- Todos los recursos se identifican por UUID (36 caracteres).
- Tipos de implemento segun backend: fungible, no_fungible.

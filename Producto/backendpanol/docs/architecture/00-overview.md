...
- Fuente de verdad: `ArchitectureTest`, estructura de paquetes en `src/main/java`, `Producto/databasepanol/migrations/v25/V25..V53` y `docs/architecture/data-management/03-postgresql-guia-tecnica.md`

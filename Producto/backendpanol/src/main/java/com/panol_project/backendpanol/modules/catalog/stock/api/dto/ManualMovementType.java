...
public enum ManualMovementType {
    ...
    ManualMovementType(String literal) {
    ...
    @JsonCreator
    public static ManualMovementType fromJson(String raw) {
        if (raw == null) {
            return null;
        }
        ...
        return Arrays.stream(values())
                ...
                .findFirst()
                .orElseThrow(() -> new IllegalArgumentException("movement_type invalido: " + raw));
    }
}
